...
const TwoImg = ()=>{
    return(<>
        <div className="two-container">
            <div className="cards">
                <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-70203.jpg" height="550" width="600" alt="img"  ></img>
            ...
            <div className="cards">
            <img src="https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-71819.png" height="550" width="600"  alt="img" ></img>
